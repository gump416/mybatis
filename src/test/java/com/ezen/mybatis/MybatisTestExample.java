...
public class MybatisTestExample {
	...
	public static void main(String[] args) {
		...
		int id = 200;
		Employee employee = sqlSession.selectOne(namespace + ".findById", id); //setInt()에 해당하는 역할이라 mapper에 int타입으로 지정(풀네임으로)
		System.out.println(employee);
...
//		System.out.println("신규사원 등록 완료");
		...
		updateEmp.setLastName("떡");
		updateEmp.setSalary(70000);
//		sqlSession.update(namespace + ".update2", emp);
		//sqlSession.commit(); 오토커밋중이라 주석처리함
